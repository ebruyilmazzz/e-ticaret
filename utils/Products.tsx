export const products = [
    {
      ...
      name: "iphone 14",
      description: " iPhone 14, Apple'ın 2022'de çıkardığı 6.1 inçlik bir akıllı telefondur. Super Retina XDR OLED ekran, A15 Bionic çip, 12 MP ana kamera ve 12 MP ultra geniş açılı ikinci kamera sunar. 5G desteği, Wi-Fi 6, Bluetooth 5.3, ve Face ID gibi özellikleri de vardır. Pil ömrü, iPhone 13'e göre biraz daha uzun olup, iOS 16 ile çalışır. 128 GB, 256 GB ve 512 GB depolama seçenekleri mevcuttur. Farklı renklerde (siyah, beyaz, mavi, mor, kırmızı) sunulmaktadır.",
      price: 2999,
      brand: "apple",
      category: "Phone",
      inStock: true,
    ...
    },
    {
      ...
      category: "Accesories",
      inStock: true,
      image: "/images/products/logitech-mx.png",
      reviews: [
        {
    ...
    },
    {
      ...
      category: "Phone",
      inStock: true,
      image: "/images/products/iphone12.png",
      reviews: [
        {
    ...
    },
    {
      ...
      category: "Accesories",
      inStock: true,
      image: "/images/products/logitech-mx-master.png",
      reviews: [],
    },
    {
